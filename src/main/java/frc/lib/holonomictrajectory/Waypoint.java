...
public class Waypoint {
   ...
   * @return A waypoint to be used for trajectory generation
   */
   ...
   *
   * @return The translation component of the waypoint
   */
   ...
   *
   * @return The drive rotation component of the waypoint (or an empty optional if not specified)
   */
   ...
   * specified).
   *
   * @return The holonomic rotation component of the waypoint (or an empty optional if not
   *     specified)
   */
