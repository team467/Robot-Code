...
public class RobotPose2022AngleToTargetCMD extends CommandBase {
    private static final Logger LOGGER =
        RobotLogManager.getMainLogger(RobotPose2022AngleToTargetCMD.class.getName());
    private final RobotPose2022 robotPose;


  public RobotPose2022AngleToTargetCMD(RobotPose2022 robotPose) {
  ...
  public void initialize() {
    LOGGER.debug("Updating robot's angle to target");
  }

  @Override
  public void execute() {
    robotPose.getAngleToTarget();
