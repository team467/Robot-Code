...
/**
 * Autonomous mode: 1. The robot shoots the pre-loaded ball. 2. It drives to get the second ball. 3.
 * It then drives up and shoots it. 4. Then drives off the tarmac.
 */
