  ...
  public void initialize() {
    if (HubTarget.hasTarget()) {
      Translation2d output =
          HubTarget.getTranslation2d()
              .minus(new Translation2d(1, HubTarget.getRotation2d().unaryMinus()));
      command =
          new GoToTrajectoryCMD(
              ...
              List.of(),
              new Pose2d(output.getX(), -output.getY(), HubTarget.getRotation2d().unaryMinus()),
              false);
      command.schedule();
    } else {
