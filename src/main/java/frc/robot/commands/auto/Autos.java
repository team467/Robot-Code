...
public class Autos {
  ...
  public Command threeNoteAutoLeftOnly() {
    ...
    return setNotePositions(() -> position)
        ...
        .andThen(orchestrator.turnToSpeaker())
        .andThen(
            arm.toSetpoint(new Rotation2d(Units.degreesToRadians(17.5)))
                .withTimeout(1)
                .andThen(orchestrator.shootBasic()));
  }
