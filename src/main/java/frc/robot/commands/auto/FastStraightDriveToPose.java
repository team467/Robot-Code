...
public class FastStraightDriveToPose extends Command {
  ...
  public FastStraightDriveToPose(
  ...
  public FastStraightDriveToPose(Pose2d targetPose, Drive drive) {
    this(drive, () -> targetPose, DRIVE_TOLERANCE);
  }

  public FastStraightDriveToPose(Drive drive, Pose2d targetPose) {
    this(drive, () -> targetPose, DRIVE_TOLERANCE);
  }

  public FastStraightDriveToPose(Drive drive, Supplier<Pose2d> targetPoseSupplier) {
