...
// all these imports bring all the external things we need

public class HopperBeltSparkMax
    implements HopperBeltIO { // meants that it will define the methods in the IO thing

  private final SparkMax motor; // object controllin motor
  private final RelativeEncoder encoder; // reads motor speed

  public HopperBeltSparkMax() { // constructor for the class,
  ...
  @Override // impliments the updateInputs method from the interface, called every 20 mili seconds
  ...
  @Override // implements the stop method from interface, and sets the speed to 0, aka immidately
  // stop
  public void stop() {
    motor.set(0.0);
  }
