...
public class stereoVisionIOPhotonVision implements stereoVisionIO {
  ...
  public void updateInputs(stereoVisionInputs inputs) {
    ...
    var results1 = camera1.getLatestResult().getTargets();
    var results2 = camera2.getLatestResult().getTargets();
    ...
    inputs.seesGamePiece = objectObservations.isEmpty();
  ...
  //      PhotonPipelineResult lowestDisparity = new PhotonPipelineResult();
