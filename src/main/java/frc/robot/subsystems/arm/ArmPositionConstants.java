...
public class ArmPositionConstants {
  ...
  public static final ArmPosition HOME = new ArmPosition(0.005, 0.024);
  ...
  public static final ArmPosition SHELF_CUBE_RETRACT =
      new ArmPosition(HOME.extendSetpoint, SHELF_CUBE.rotateSetpoint);
  public static final ArmPosition SHELF_CONE_RETRACT =
      new ArmPosition(HOME.extendSetpoint, SHELF_CONE.rotateSetpoint);
  public static final ArmPosition CUBE_FLOOR_RETRACT =
      new ArmPosition(HOME.extendSetpoint, CUBE_FLOOR.rotateSetpoint);
