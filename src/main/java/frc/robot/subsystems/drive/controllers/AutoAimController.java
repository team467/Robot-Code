...
public class AutoAimController {
    private static final TunableNumber headingkP =
            new TunableNumber("AutoAim/kP", 1.0);
    private static final TunableNumber headingkD =
            new TunableNumber("AutoAim/kD", 0.0);
    private static final TunableNumber tolerance =
            new TunableNumber("AutoAim/ToleranceDegrees", 4.0);
